...
LOCATION=models/nytimes/doublefnvnllgram1a2a4a8a16size16777216dimension16a0.1b0alpha0lambda${LAMBDA}n0rho0split
...
${BYTESTEADYBIN} -driver_location ${LOCATION} -driver_epoch_size 100 -driver_save 0 -data_file data/nytimes/train_shuffle_split_0.hex -data_format kBytes -model_gram '{1,2,4,8,16}' -model_input_size 16777216 -model_output_size 8 -model_dimension 16 -train_a 0.1 -train_b 0 -train_alpha 0 -train_lambda ${LAMBDA} -train_n 0 -train_rho 0 "${@:2}";
