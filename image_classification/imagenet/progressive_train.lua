...
Usage: th progressive_train.lua [category_file] [data_directory]
   [output_directory] [quality] [threads]
--]]
...
function joe.main()
   ...
   local data_directory = arg[2] or 'data/trainsize72quality75centercrop64'
   local output_directory = arg[3] or
      'data/trainsize72quality75centercrop64progressive'
...
function joe.constructTrain(
      category_file, data_directory, output_directory, quality, threads)
   -- Tunnel RPC executer
