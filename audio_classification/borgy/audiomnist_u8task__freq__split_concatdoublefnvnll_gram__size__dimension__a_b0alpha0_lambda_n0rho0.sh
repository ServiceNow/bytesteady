...
LOCATION=models/AudioMNIST/u8${TASK}freq${FREQ}split${SPLIT}concatdoublefnvnllgram${GRAM}size${SIZE}dimension${DIMENSION}a${A}b0alpha0lambda${LAMBDA}n0rho0split
